  ...
  <div class="kuis-body">
    <div class="kuis-sidebar">
      ...
      <div class="kuis-progress">
        <small>Progres: <span id="progress-text">0/10</span></small>
        <div class="progress">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Apakah kamu yakin telah selesai menjawab kuis ini?
      </div>
      <div class="modal-footer">
        <button type="button" class="btnb-kuis1 btn-danger" data-bs-dismiss="modal">BATAL</button>
        <button type="button" class="btns-kuis1 btn-success" onclick="selesaiKuis()">SELESAI</button>
      </div>
    </div>
  </div>
</div>
