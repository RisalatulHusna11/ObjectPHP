...
<div class="materi-subbab1" style="padding: 30px 0;">
  <div class="nextphp-kuis-guide">
    <h2 class="nextphp-kuis-title">KUIS 2</h2>
    <p class="nextphp-kuis-subtitle">Mendeklarasikan Class</p>

    <div class="nextphp-kuis-instructions">
      <h5>Petunjuk Pengerjaan Kuis</h5>
      <ol>
        <li>Kuis ini terdiri dari <strong>5 soal interaktif</strong> mengenai materi Mendeklarasikan Class. Untuk memulai kuis, klik tombol <strong>"MULAI"</strong>.</li>
    ...
    <div class="nextphp-kuis-btn-group">
      <a href="/b211-kuis" class="nextphp-btn-mulai">MULAI</a>
      <a href="/b29-destructor" class="nextphp-btn-kembali">KEMBALI</a>
    </div>
  </div>
</div>
@endsection
