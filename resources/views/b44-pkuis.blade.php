...
<div class="materi-subbab1" style="padding: 30px 0;">
  <div class="nextphp-kuis-guide">
    <h2 class="nextphp-kuis-title">KUIS 4</h2>
    <p class="nextphp-kuis-subtitle">Introspection</p>

    <div class="nextphp-kuis-instructions">
      <h5>Petunjuk Pengerjaan Kuis</h5>
      <ol>
        <li>Kuis ini terdiri dari <strong>5 soal interaktif</strong> mengenai materi Introspection. Untuk memulai kuis, klik tombol <strong>"MULAI"</strong>.</li>
    ...
    <div class="nextphp-kuis-btn-group">
      <a href="/b45-kuis" class="nextphp-btn-mulai">MULAI</a>
      <a href="/b41-memeriksac" class="nextphp-btn-kembali">KEMBALI</a>
    </div>
  </div>
</div>
@endsection
